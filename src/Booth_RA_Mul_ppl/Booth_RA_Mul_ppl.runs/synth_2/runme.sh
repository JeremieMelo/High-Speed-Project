...
HD_PWD='D:/Jake_Gu/UT Austin/GitHub/High-Speed-Project/src/Booth_RA_Mul_ppl/Booth_RA_Mul_ppl.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log RA_Mul_ppl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RA_Mul_ppl.tcl
