...
HD_PWD='D:/Jake_Gu/UT Austin/GitHub/High-Speed-Project/src/Booth_RA_Mul_ppl/Booth_RA_Mul_ppl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RA_Mul_ppl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RA_Mul_ppl.tcl -notrace
