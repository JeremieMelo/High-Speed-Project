...
HD_PWD='D:/Jake_Gu/UT Austin/GitHub/High-Speed-Project/src/Booth_RA_Mul/Booth_RA_Mul/Booth_RA_Mul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RA_Mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RA_Mul.tcl
