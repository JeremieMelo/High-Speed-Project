...
HD_PWD='D:/Jake_Gu/UT Austin/GitHub/High-Speed-Project/src/Booth_RA_Mul/Booth_RA_Mul/Booth_RA_Mul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RA_Mul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RA_Mul.tcl -notrace
