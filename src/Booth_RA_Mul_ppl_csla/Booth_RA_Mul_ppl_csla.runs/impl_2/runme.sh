...
HD_PWD='D:/Jake_Gu/UT_Austin/GitHub/High-Speed-Project/src/Booth_RA_Mul_ppl_csla/Booth_RA_Mul_ppl_csla.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log RA_Mul_ppl_csla.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RA_Mul_ppl_csla.tcl -notrace
