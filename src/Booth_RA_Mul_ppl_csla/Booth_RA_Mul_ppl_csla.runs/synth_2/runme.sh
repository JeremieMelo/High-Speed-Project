...
HD_PWD='D:/Jake_Gu/UT_Austin/GitHub/High-Speed-Project/src/Booth_RA_Mul_ppl_csla/Booth_RA_Mul_ppl_csla.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log RA_Mul_ppl_csla.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RA_Mul_ppl_csla.tcl
